...
odd <- c(240165, 230302, 230307) 
         
nbreed <- c(230300, 230306, 230319, 232980, 234235, 238543, 240157,240160, 240162, 240163, 
            240166, 240169, 242571, 230316,230315, 240155) 
...
breedsf <- arf_sf %>% 
  mutate(breed_class = case_when(
     tag.local.identifier %in%  pc ~ "princec_baffin",
