...
at <- readRDS(file.path(raw_dat, filesoi[2]))
eccc <- readRDS(file.path(raw_dat, filesoi[4]))
ma <- readRDS(file.path(raw_dat, filesoi[5]))
oc <- readRDS(file.path(raw_dat, filesoi[7]))
mils <- readRDS(file.path(raw_dat, filesoi[6]))
dom <- readRDS(file.path(raw_dat, filesoi[3]))

all <- bind_rows(at, eccc, ma, oc, dom, mils)
